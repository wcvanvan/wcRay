...
std::shared_ptr<HittableList> final_scene() {
    ...
    objects.add(make_shared<FlipFace>(make_shared<xz_rect>(200, 360, 220, 340, 554.99, light)));
...
//    // Fill with spheres
    auto earth_texture = make_shared<image_texture>(R"(D:\Projects\SoftwarePathTracing\resources\earthmap.jpg)");
...
int main() {
    ...
    switch (scene) {
        case 1:
            ...
            vfov = 40.0;
            lights->add(make_shared<xz_rect>(200, 360, 220, 340, 554.99, nullptr));
            break;
        case 2:
            world = final_scene();
            aspect_ratio = 1.0;
